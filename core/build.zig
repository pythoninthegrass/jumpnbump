...
const unit_test_files = [_][]const u8{ "dat.zig", "gob.zig", "pcx.zig", "levelmap.zig", "fixed16.zig", "world.zig", "steer.zig" };
...
// main.c by core/c_ref/extract_steered.py into core/c_ref/steer.c.
const diff_test_files = [_][]const u8{ "rnd_difftest.zig", "steer_difftest.zig" };
