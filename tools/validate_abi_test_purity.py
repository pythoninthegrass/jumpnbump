...
Tier-C conformance tests (TASK-012.03) must reach core/abi.zig exclusively
through @cImport(include/jumpnbump.h) -- never by @import()ing
world.zig/game_loop.zig/levelmap.zig/rnd.zig directly. Without this guard,
