...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 zig build difftest passes against the Phase 1 corpus for all traces exercising every one of the 8 OBJ_* particle types, with zero checksum mismatches
- [ ] #2 The 200-slot objects[] array's reuse/allocation behavior matches the C original exactly
<!-- AC:END -->
