...
- [ ] #2 Regenerating all Godot assets from the original data/ files twice produces byte-identical output both times
- [ ] #3 A `task audio:check`-equivalent gate exists and passes in CI
<!-- AC:END -->
